...
public class Home extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) 
		...
		URL url_ws_evento = new URL(propiedades.getProperty("url_ws_eventos"));
    	WSEventoService service = new WSEventoService(url_ws_evento);
    	...
    	for (String nomEvt : nomEventos) {
            ...
            DtEvento evento = portEvento.getDTEvento(nomEvt);

            // Filtrar por categoría y excluir los eventos finalizados
            if ((!filtrar || categorias.contains(categoria)) && !evento.isFinalizado()) {
